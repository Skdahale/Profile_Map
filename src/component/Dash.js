    ...
    <div className="bg-zinc-100  flex w-screen h-screen overflow-hidden">
      ...
      <div className=" static p-4 sm:ml-64 z-50 hover:outline-blue-400 max-w-full max-h-full w-full h-full overflow-y-scroll ">
        ...
        <div class="flex items-center px-3 py-2 rounded-lg bg-blue-200 border border-slat-600">
          ...
          <div>
          <img width="64" height="64" src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/external-user-profile-market-research-flaticons-lineal-color-flat-icons.png" alt="external-user-profile-market-research-flaticons-lineal-color-flat-icons"/>
          </div>
          <button
            type="button"
          ...
          ></textarea>
          <button className="text-base p-2 hover:outline-offset-2 hover:scale-110 z-10 bg-slate-100 border border-gray-400 flex justify-center items-center rounded-lg duration-300 hover:border-slate-900 hover:text-white focus:stroke-blue-200 focus:border-slate-200 focus:bg-blue-400">
